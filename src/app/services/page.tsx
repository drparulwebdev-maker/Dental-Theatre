...
export default function ServicesPage() {
  ...
  return (
    <div className="flex w-full flex-col">
      {/* Page hero */}
      <section className="relative py-20 lg:py-28 overflow-hidden bg-[#0a192f] text-white">
        ...
        <div className="container relative z-10 mx-auto max-w-7xl px-6 text-center lg:px-10">
          <FadeIn direction="up">
            <div className="mx-auto mb-6 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-[11px] font-bold tracking-[0.25em] text-sky-200 backdrop-blur-md uppercase">
                  ...
                  {services.map((service, i) => {
                    ...
                    return (
                      <FadeIn key={service.slug} direction="up" delay={i * 0.05}>
                        <Card
                          id={service.slug}
                          className="group relative flex h-full flex-col overflow-hidden rounded-[24px] border border-white/60 bg-white/70 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:bg-white hover:shadow-[0_20px_60px_-15px_rgba(11,56,102,0.12)]"
                        >
                          <CardContent className="flex flex-grow flex-col p-6">
                            <div className="mb-5 flex items-center gap-4">
                              <div className="flex size-12 shrink-0 items-center justify-center rounded-2xl border border-primary/10 bg-primary/5 text-primary transition-colors group-hover:bg-primary group-hover:text-white">
                            ...
                            <p className="mb-6 flex-grow text-sm leading-[1.7] text-muted-foreground">
                              {service.description}
                            </p>
      ...
      <section className="relative overflow-hidden py-24 bg-primary text-white">
        ...
        <div className="container relative z-10 mx-auto max-w-4xl px-6 text-center lg:px-10">
          <FadeIn direction="up">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-[16px] leading-relaxed text-white/80">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 rounded-xl border-white/20 bg-white/5 px-8 text-[15px] font-bold text-white hover:bg-white/10 hover:text-white"
